...
const PortfolioChatBot = () => {
  ...
  {
    id: '1',
    text: "Hey! I'm Portfolio Bot 👋 Ask me anything about Atharva — his experience, skills, projects, or how to get in touch.",
    isBot: true,
    timestamp: new Date()
  }]
  );
  ...
  "What is Atharva's backend experience?",
  "What technologies does Atharva specialise in?",
  "How can I get in touch with Atharva ?",
  ];
